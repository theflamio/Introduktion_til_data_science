...
```{r, results="hide"}
optimal_cp <- 0.057 ## from printcp/plotcp output.
...
```
### 3.3.5 Make predictions and evaluated the tree model and Pruned tree model
...
```
### 3.5.3 Predict and evaluated LDA and QDA
