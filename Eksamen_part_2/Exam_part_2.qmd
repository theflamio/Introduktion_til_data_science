...
```{r}
optimal_cp = 0.048 #lets try it beacuse we want to see how it dose hold up
...
```
### 3.3.5 Predict tree model and Pruned tree model. setup confusion Matrix.
...
```
### 3.4.2 Predict Random forrest and Random forrest Tuned setup confusion Matrix.
...
```
### 3.5.3 Predict LDA and QDA setup confusion Matrix 
...
```
### 3.5.4 Evaluation of all classifications models
